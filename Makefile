...
SYSTEM ?= $(HOST_SYSTEM)
CXX = g++
CPPFLAGS += -I/usr/local/include -I${PROTOBUF_INCLUDE_DIR} -pthread -I${JDK_HOME}/include -Isrc/main/native/agent -Itarget/generated-sources/protobuf/native -c -fPIC -fpermissive
CXXFLAGS += -std=c++11
ifeq ($(SYSTEM),Darwin)
