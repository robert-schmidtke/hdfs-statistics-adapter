...
HDFS_STANDARD_OPTS="--blocksize 268435456 --replication 1 --memory 61440 --io-buffer 1048576 --colocate-datanode-with-namenode"
...
$HADOOP_HOME/bin/hadoop jar \
  ...
  10000000 hdfs://$MASTER:8020/user/$USER/input
