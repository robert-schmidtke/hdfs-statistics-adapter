...
OPTS="$OPTS,bin_duration=1000,cache_size=120,out_dir=/tmp,verbose=n,out_fmt=bb,os_pool_size=1000,dos_pool_size=1000,rdos_pool_size=1000,tq_pool_size=1000,lq_lock_cache=1024,os_lock_cache=1024,trace_fds=y,trace_mmap=n,instr_skip=n,use_proxy=n"
